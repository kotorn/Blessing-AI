...
The current candidate `d11a2d8` passed the non-secret unit and frontend gates
in GitHub Actions run `34754880989`. The credentialed contract workflow records
