...
|---|---|---|
| Reproducible `npm ci`, TypeScript lint/tests/build | `LOCAL_VERIFIED; CI_VERIFIED` | Current checkpoint `9398c3d711f86bc9ef8f728d4929789544dc95ac`; GitHub Actions run `34785048703` passed Node install/lint/tests/build. |
| Worker import smoke and non-secret Python tests | `LOCAL_VERIFIED; CI_VERIFIED` | Current checkpoint `9398c3d711f86bc9ef8f728d4929789544dc95ac`; GitHub Actions run `34785048703` passed Python install/tests and hygiene. |
...
| GitHub CI for verified safety/research implementation candidate `9398c3d` | `CI_VERIFIED` | Run `34785048703` passed Node install/lint/tests/build, Python install/tests, and hygiene |
...
`9398c3d711f86bc9ef8f728d4929789544dc95ac`. GitHub CI verified that same code
checkpoint in run `34785048703`.
