...
|---|---|---|
| Reproducible `npm ci`, TypeScript lint/tests/build | `LOCAL_VERIFIED; CI_VERIFIED` | Current candidate `d11a2d8`; GitHub Actions run `34754880989` passed Node install/lint/tests/build. |
| Worker import smoke and non-secret Python tests | `LOCAL_VERIFIED; CI_VERIFIED` | Current candidate `d11a2d8`; GitHub Actions run `34754880989` passed Python install/tests and hygiene. |
...
| GitHub CI for current candidate `d11a2d8` | `CI_VERIFIED` | Run `34754880989` passed Node install/lint/tests/build, Python install/tests, and hygiene |
...
verified the current candidate `d11a2d8` in run `34754880989`.
