...
|---|---|---|
| Reproducible `npm ci`, TypeScript lint/tests/build | `LOCAL_VERIFIED; CI_VERIFIED` | Latest safety/research code candidate `5fc2f54`; GitHub Actions run `34763686594` passed Node install/lint/tests/build. |
| Worker import smoke and non-secret Python tests | `LOCAL_VERIFIED; CI_VERIFIED` | Latest safety/research code candidate `5fc2f54`; GitHub Actions run `34763686594` passed Python install/tests and hygiene. |
...
| GitHub CI for latest safety/research code candidate `5fc2f54` | `CI_VERIFIED` | Run `34763686594` passed Node install/lint/tests/build, Python install/tests, and hygiene |
...
GitHub CI verified that candidate `5fc2f54` in run `34763686594`.
