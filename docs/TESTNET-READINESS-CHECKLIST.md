...
|---|---|---|
| Reproducible `npm ci`, TypeScript lint/tests/build | `LOCAL_VERIFIED; CI_VERIFIED` | Current checkpoint `3501414ac33685f60fc1bf2dc7536d14b1e277a0`; GitHub Actions run `34779085395` passed Node install/lint/tests/build. |
| Worker import smoke and non-secret Python tests | `LOCAL_VERIFIED; CI_VERIFIED` | Current checkpoint `3501414ac33685f60fc1bf2dc7536d14b1e277a0`; GitHub Actions run `34779085395` passed Python install/tests and hygiene. |
...
| GitHub CI for verified safety/research implementation candidate `3501414` | `CI_VERIFIED` | Run `34779085395` passed Node install/lint/tests/build, Python install/tests, and hygiene |
...
`3501414ac33685f60fc1bf2dc7536d14b1e277a0`. GitHub CI verified that same code
checkpoint in run `34779085395`.
