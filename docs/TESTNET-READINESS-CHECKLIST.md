...
|---|---|---|
| Reproducible `npm ci`, TypeScript lint/tests/build | `LOCAL_VERIFIED; CI_VERIFIED` | Latest safety/research code candidate `436b1b8`; GitHub Actions run `34760374245` passed Node install/lint/tests/build. |
| Worker import smoke and non-secret Python tests | `LOCAL_VERIFIED; CI_VERIFIED` | Latest safety/research code candidate `436b1b8`; GitHub Actions run `34760374245` passed Python install/tests and hygiene. |
...
| GitHub CI for latest safety/research code candidate `436b1b8` | `CI_VERIFIED` | Run `34760374245` passed Node install/lint/tests/build, Python install/tests, and hygiene |
...
GitHub CI verified that candidate `436b1b8` in run `34760374245`.
